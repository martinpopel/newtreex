...
public class TextModeTrees extends Block {
    ...
    public void processTree(NLPTree xtree, int bundleNo) {
        ...
        for (cz.cuni.mff.ufal.treex.core.Node descendant : xtree.getRoot().getDescendants()) {
    ...
    private String nodeToString(cz.cuni.mff.ufal.treex.core.Node node) {
    ...
    private static class Node {
        ...
        int leftmost;
        int rightmost;
        cz.cuni.mff.ufal.treex.core.Node xNode;
    }
}
