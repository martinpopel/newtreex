...
import cz.cuni.mff.ufal.treex.core.impl.DefaultBundle;
import cz.cuni.mff.ufal.treex.core.impl.DefaultDocument;
...
public class Run {
    ...
    private static final String BLOCK_PACKAGE_PREFIX = "cz.cuni.mff.ufal.treex.block.";
    private static final String UD_BLOCK_PREFIX = "UD::Block::";
